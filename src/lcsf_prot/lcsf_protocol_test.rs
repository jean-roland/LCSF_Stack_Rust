...
mod tests {
    use super::*;
    use protocol_test_a::Ca2AttCa3Payload;
    use protocol_test_a::Ca3AttCa4Payload;
    use protocol_test_a::Cc1AttPayload;
    use protocol_test_a::Cc4AttCa1Payload;
    use protocol_test_a::Cc4AttCa2Payload;
    use protocol_test_a::Cc4AttPayload;
    ...
    fn test_send_cmd() {
        ...
        let valid_cc1_cmd = LcsfValidCmd {
            ...
            att_arr: vec![
                ...
                LcsfValidAtt {
                    payload: LcsfValidAttPayload::Data(vec![0xa1, 0x86, 0x01]),
                },
                LcsfValidAtt {
                ...
                LcsfValidAtt {
                    payload: LcsfValidAttPayload::Data(vec![0xf0, 0x49, 0x02]),
                },
                LcsfValidAtt {
        ...
        let valid_cc3_cmd = LcsfValidCmd {
            ...
            att_arr: vec![
                ...
                LcsfValidAtt {
                    payload: LcsfValidAttPayload::Data(vec![0xa0, 0x86, 0x01]),
                },
                LcsfValidAtt {
                    payload: LcsfValidAttPayload::Data(vec![5, 4, 3, 2, 1]),
                },
                ...
                LcsfValidAtt {
                    payload: LcsfValidAttPayload::Data(vec![0xef, 0x49, 0x02]),
                },
                LcsfValidAtt {
                    payload: LcsfValidAttPayload::Data(Vec::new()),
                },
